...
SHADER_REPOS=${SHADER_REPOS:-"https://github.com/Filoppi/PumboAutoHDR/Shaders/Pumbo/|pumbo-hdr;https://github.com/EndlesslyFlowering/ReShade_HDR_shaders|lilium-hdr;https://github.com/MaxG2D/ReshadeSimpleHDRShaders|maxg2d-hdr"}
...
mv ./easy-linux-hdr/hdr_patch.sh $HOME/.local/share/reshade/
mv ./easy-linux-hdr/hdr_autoswitch.sh $HOME/.local/share/reshade/
