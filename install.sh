...
SHADER_REPOS=${SHADER_REPOS:-"https://github.com/TheCyberArcher/auto-hdr-repo/|pumbo-hdr;https://github.com/EndlesslyFlowering/ReShade_HDR_shaders|lilium-hdr;https://github.com/MaxG2D/ReshadeSimpleHDRShaders|maxg2d-hdr"}
