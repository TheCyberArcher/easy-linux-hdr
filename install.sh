...
SHADER_REPOS=${SHADER_REPOS:-"https://github.com/Filoppi/PumboAutoHDR|pumbo-hdr;https://github.com/EndlesslyFlowering/ReShade_HDR_shaders|lilium-hdr;https://github.com/MaxG2D/ReshadeSimpleHDRShaders|maxg2d-hdr"}
